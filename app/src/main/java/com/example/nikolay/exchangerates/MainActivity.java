...
import com.example.nikolay.exchangerates.Current_Rate.Controller;
import com.example.nikolay.exchangerates.Current_Rate.ExchangeApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView textView_eur,textView_rur,textView_usd,textView_btc;
    private Button button_exchange,button_chart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_eur=(TextView)findViewById(R.id.textView_eur);
        textView_rur=(TextView)findViewById(R.id.textView_rur);
        textView_usd=(TextView)findViewById(R.id.textView_usd);
        textView_btc=(TextView)findViewById(R.id.textView_btc);
        ...
        button_exchange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,ExchangeHistory.class);
        ...
        exchangeApi= Controller.getApi();
        exchangeApi.getData().enqueue(new Callback<List<JsonModel>>() {
            @Override
    ...
    public void sendNotification(){
        ...
        stackBuilder.addParentStack(ExchangeHistory.class);
        Intent resultIntent=new Intent(this,ExchangeHistory.class);
